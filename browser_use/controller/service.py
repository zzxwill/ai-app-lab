        ...
        async def select_dropdown_option(
            ...
            try:
                ...
                for frame in page.frames:
                    try:
                        logger.debug(
                            f'Trying frame {frame_index} URL: {frame.url}')
