package com.bytedance.ai.multimodal.copilot.init
...
import com.bytedance.ai.multimodal.copilot.bridge.CopyMessageMethod
import com.bytedance.ai.multimodal.copilot.bridge.LikeMethod
...
object AIBridgeInitializer {
    ...
    fun init() {
        GlobalMethodSeeker.register(CopyMessageMethod::class.java)
        GlobalMethodSeeker.register(LikeMethod::class.java)
