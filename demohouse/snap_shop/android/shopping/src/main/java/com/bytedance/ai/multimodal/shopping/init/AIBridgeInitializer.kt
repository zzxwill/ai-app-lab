package com.bytedance.ai.multimodal.shopping.init
...
import com.bytedance.ai.multimodal.shopping.bridge.CloseMethod
import com.bytedance.ai.multimodal.shopping.bridge.GenerateMd5Method
import com.bytedance.ai.multimodal.shopping.bridge.TriggerVibrateMethod
...
object AIBridgeInitializer {
    ...
    fun init() {
        GlobalMethodSeeker.register(GenerateMd5Method::class.java)
        GlobalMethodSeeker.register(CloseMethod::class.java)
        GlobalMethodSeeker.register(TriggerVibrateMethod::class.java)
