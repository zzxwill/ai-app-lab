...
下文将引导您通过火山方舟应用实验室功能，快速创建 DeepSearch MCP 应用实例。

1. 在火山方舟控制台侧边栏，选择 【应用实验室>我的应用】，点击页面中的【创建应用】。

    ![img_2.png](docs/img_2.png)

2. 应用类型选择【高代码】，点击【确定创建】。

    ![img_1.png](docs/img_1.png)

3. 在应用编辑页面中，填写应用名称，并点击【创建新函数】。

    ![img_3.png](docs/img_3.png)

4. 在弹出的窗口中，应用原型选择【DeepSearch】，点击【确认】。在随后弹出的【开通及创建授权】窗口中，确认相关服务是否完成开通，确认无误后点击【立即创建】。

    ![img_4.png](docs/img_4.png)
    ![img_5.png](docs/img_5.png)

5. 在【创建并部署函数】的引导页面，按需配置以下内容：

    ![img_6.png](docs/img_6.png)
    
   - 若开启知识库 MCP 服务，需选择可用于检索的知识库，并填写知识库描述作为 MCP Server 的描述，以便模型判断是否使用。
   - 若开启日志 MCP 服务，需选择可用于检索的日志项目和主题，关于知识库的创建可查看产品文档。
   - 推荐开启【日志服务-Trace】功能，方便后续线上问题定位和排查，同时支持通过可视化的调试面板查看会话执行细节。

6. 完成配置后，点击【确定】开始自动部署。部署完成后，点击下方的【立即体验】即可使用该应用。
